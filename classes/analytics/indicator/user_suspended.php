...
/**
 *
 * @package   local_skeleton_am_analitics
 * @copyright 2017 David Monllao {@link http://www.davidmonllao.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace local_skeleton_am_analitics\analytics\indicator;
...
class user_suspended extends \core_analytics\local\indicator\binary {
    ...
    public static function get_name(): \lang_string {
        return new \lang_string('suspendeduser', 'local_skeleton_am_analitics');
    }
